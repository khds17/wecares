                                ...
                                <div class="container">
                                    <div class="row align-items-center">
                                        <div class="col-lg-6" data-aos="fade-up">
                                            ...
                                            <a class="btn btn-purple btn-marketing btn-block rounded-pill lift lift-sm" id="botaoEncontreCuidadores" href="{{url("/encontreCuidador")}}">Encontre cuidadores</a>
                                            <a class="btn btn-green btn-marketing btn-block rounded-pill lift lift-sm" id="botaoSejaUmCuidador" href="{{url("prestador/create")}}">Seja um cuidador</a>
                                        </div>
