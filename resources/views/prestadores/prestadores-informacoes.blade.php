...
@section('content')
    ...
    <div class="col-8 m-auto">
        ...
        <br><br>
        <a href="">
            <button class="btn btn-success" onclick="aprovar({{$prestadores->ID_USUARIO}})">Aprovar</button>
        </a>
        <a href="">
            <button class="btn btn-danger" onclick="reprovar({{$prestadores->ID_USUARIO}})">Reprovar</button>
        </a>
