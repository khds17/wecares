...
<!--<![endif]-->
    <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #ededf1;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
      ...
      <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
        ...
        <h1 style="Margin-top: 12px;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #3e4751;font-size: 22px;line-height: 31px;font-family: Ubuntu,sans-serif;text-align: center;">Parabéns {{$prestador->NOME}}, você foi {{$prestador->ID_SEXO == 1 ? 'aprovada' : 'aprovado'}} na nossa plataforma!</h1>
        <p style="Margin-top: 20px;Margin-bottom: 20px;">
            <center><span>Nossa equipe fica muito feliz em ter você como profissional e esperamos que possa receber muitas propostas de trabalho,
                agora a nossa indicação é que acesse a plataforma pelo botão abaixo e cadastre sua conta bancária para o repasse dos recebimentos dos serviços que realizar! Qualquer dúvida, entre em contato com a nossa equipe pelo e-mail contato@wecares.com.br&nbsp;</span></center>
        </p>
      </div>
    </div>
      ...
      <div class="btn btn--flat btn--large" style="text-align:center;">
        <![if !mso]><a style="border-radius: 4px;display: inline-block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #ffffff !important;background-color: #4eaacc;font-family: PT Serif, Georgia, serif;" href="https://wecares.com.br/recebimentos">Acessar a plataforma</a><![endif]>
      <!--[if mso]><p style="line-height:0;margin:0;">&nbsp;</p><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="http://test.com" style="width:245px" arcsize="9%" fillcolor="#4EAACC" stroke="f"><v:textbox style="mso-fit-shape-to-text:t" inset="0px,11px,0px,11px"><center style="font-size:14px;line-height:24px;color:#FFFFFF;font-family:PT Serif,Georgia,serif;font-weight:bold;mso-line-height-rule:exactly;mso-text-raise:4px">READ THE FULL BLOG POST</center></v:textbox></v:roundrect><![endif]--></div>
    </div>
