...
<!--<![endif]-->
    <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #ededf1;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
      ...
      <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
        ...
        <h1 style="Margin-top: 12px;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #3e4751;font-size: 22px;line-height: 31px;font-family: Ubuntu,sans-serif;text-align: center;">{{$prestador->NOME}} infelizmente você não foi {{$prestador->ID_SEXO == 1 ? 'aprovada' : 'aprovado'}} :(</h1>
        <p style="Margin-top: 20px;Margin-bottom: 20px;">
            <center><span>Não desanime! Outras oportunidades surgiram, aproveite este momento para fazer novos cursos e aprofundar seus conhecimentos na área&nbsp;</span></center>
        </p>
      </div>
    </div>
      ...
      <div class="btn btn--flat btn--large" style="text-align:center;">
        {{-- <![if !mso]><a style="border-radius: 4px;display: inline-block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #ffffff !important;background-color: #4eaacc;font-family: PT Serif, Georgia, serif;" href="https://wecares.com.br/servicosPrestados">Ver informações do serviço</a><![endif]> --}}
