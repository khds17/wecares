...
use App\Http\Requests\RequestAdministrators;
...
class AdministratorsController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(RequestAdministrators $request)
    {
        DB::beginTransaction();
        ...
        try {
            ...
            return redirect()->action('AdministratorsController@listaAdmins');

        } catch (\Throwable $th) {
            DB::rollback();

            return redirect()->action('AdministratorsController@create');
        }
